...
## What you need
- A working computer
- <a target='_blank' href='https://etrnl.app/shop'>An ETRNL NFC Tag</a>
...
Now you can just hold your NFC Tag to the reader until you get the <b>Success</b> message.
...
<Frame>
	<img src='/images/quickstart/program-tag.gif' alt='ETRNL NFC Programmer'/>
</Frame>
...
If you're having trouble reading the tag, locl the phone and unlock it while the tag is touching the top of the phone.
<Note>
Based on our testing, IPhones don't poll for NFC tags frequently.
However, immediately after waking your IPhone, it will emit the strongest frequencies to communicate with nearby NFC tags.
</Note>
